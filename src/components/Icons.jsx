export function Logo() {
  return (
    <svg width="32" height="26" viewBox="0 0 32 26" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Movie logo">
      <path
...
export function TvSeriesIcon() {
  return (
    <svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-hidden="true">
      <path
        d="M11.2 0H.8a.8.8 0 0 0-.8.8v8.9c0 .44.36.8.8.8h10.4a.8.8 0 0 0 .8-.8V.8a.8.8 0 0 0-.8-.8ZM3.2 9.6H1.6V8h1.6v1.6Zm0-3.2H1.6V4.8h1.6v1.6Zm0-3.2H1.6V1.6h1.6v1.6Zm5.41 4.69L5.2 6.96V3.04l3.41 1.95a.4.4 0 0 1 0 .7Zm1.79 1.71H8.8V8h1.6v1.6Zm0-3.2H8.8V4.8h1.6v1.6Zm0-3.2H8.8V1.6h1.6v1.6Z"
      />
    </svg>
  )
}
...
export function SearchIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <line x1="15.5" y1="15.5" x2="22" y2="22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
